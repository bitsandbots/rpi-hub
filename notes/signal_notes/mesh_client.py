"""Best-effort propagation of new notes to signal-mesh.

When ``signal-mesh.service`` is running, every locally-posted note is
...
MESH_PUBLISH_URL = os.environ.get(
    "SIGNAL_MESH_PUBLISH_URL", "http://127.0.0.1:8500/notes/publish"
)
MESH_PUBLISH_TIMEOUT_S = float(os.environ.get("SIGNAL_MESH_PUBLISH_TIMEOUT_S", "0.5"))

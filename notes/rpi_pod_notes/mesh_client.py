"""Best-effort propagation of new notes to rpi-pod-mesh.

When ``rpi-pod-mesh.service`` is running, every locally-posted note is
...
MESH_PUBLISH_URL = os.environ.get(
    "RPI_POD_MESH_PUBLISH_URL", "http://127.0.0.1:8500/notes/publish"
)
MESH_PUBLISH_TIMEOUT_S = float(os.environ.get("RPI_POD_MESH_PUBLISH_TIMEOUT_S", "0.5"))

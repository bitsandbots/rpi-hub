...
once per worker, and rpi-pod-retrieve runs a single worker (the model is
...
VECTORS_HNSW = Path("/var/lib/rpi-pod/index/vectors.hnsw")
VECTORS_IDS = Path("/var/lib/rpi-pod/index/vectors.ids")
EMBED_DIM = int(os.environ.get("RPI_POD_EMBED_DIM", "384"))  # bge-small-en

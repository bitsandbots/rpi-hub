...
noaa:                            # optional; consumed by rpi-hub-listen (Phase 8)
...
* `noaa.preset_frequencies_mhz` is read by rpi-hub-listen at install time
...
3. Then `./scripts/apply_pack.sh <name>` stages the resulting PDFs into
   `./payload/var/www/rpi-hub-portal/print/`.

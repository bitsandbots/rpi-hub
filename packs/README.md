# rpi-hub — Regional Content Packs

A pack is a manifest + a set of pre-curated artefacts (ZIM list, printable
PDFs, optional NOAA station presets) that turns a generic rpi-hub image
...
2. Stages printable PDFs under `/var/www/rpi-hub-portal/print/`

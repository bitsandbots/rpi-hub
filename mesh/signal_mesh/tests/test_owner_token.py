"""Owner-token reader tests for signal-mesh.

The per-domain split (`/etc/signal/mesh-owner-token` for peer
trust/block, `/etc/signal/notes-owner-token` for notes moderation) ships
...
from mesh.signal_mesh import main
